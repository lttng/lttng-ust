 ...
 *
 * LTTng lib ring buffer client (discard mode, global buffers).
 */
...
#define RING_BUFFER_MODE_TEMPLATE_STRING	"discard-global"
...
#define LTTNG_CLIENT_TYPE			LTTNG_CLIENT_DISCARD_GLOBAL
