 ...
 *
 * LTTng lib ring buffer client (overwrite mode, per-channel buffers).
 */
...
#define RING_BUFFER_MODE_TEMPLATE_STRING	"overwrite-channel"
...
#define LTTNG_CLIENT_TYPE			LTTNG_CLIENT_OVERWRITE_PER_CHANNEL
